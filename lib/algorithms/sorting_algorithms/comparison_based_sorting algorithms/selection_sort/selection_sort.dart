...
// 1. The outer for loop represents the passes, where start is the index the current pass should
//    begin at. Since the lowest value is moved to start at the end of every pass, start increments
//    by one each time.

// 2. In every pass, you go through the remainder of the collection to find the element with the
//    lowest value.
